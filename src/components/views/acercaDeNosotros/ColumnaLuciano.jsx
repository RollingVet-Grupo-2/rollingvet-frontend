                        ...
                        <Card.Body>
                            ...
                            <ListGroup className="d-flex flex-column gap-2">
                                <ItemRedSocial
                                    ...
                                    urlRedSocial={
                                        infoLuciano.redesSociales.github.url
                                    }
                                ...
                                <ItemRedSocial
                                    ...
                                    urlRedSocial={
                                        infoLuciano.redesSociales.correo.url
                                    }
                                    nombreDesarrollador={infoLuciano.nombre}
                                ></ItemRedSocial>
                                <ItemRedSocial
                                    ...
                                    nombreRedSocial={
                                        infoLuciano.redesSociales.linkedin
                                            .nombre
                                    }
                                    urlRedSocial={infoLuciano.redesSociales.linkedin.url}
                                    nombreDesarrollador={infoLuciano.nombre}
                                ></ItemRedSocial>
                            </ListGroup>
                        </Card.Body>
