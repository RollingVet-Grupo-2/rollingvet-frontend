...
const CardCliente = ({
    ...
    return (
        <Card className="rounded-4 bg-primary d-flex flex-column flex-md-row overflow-hidden h-100">
            <div className="d-flex position-relative avatarMascota">
                ...
                <div className="d-flex flex-column position-absolute top-0 p-3 gap-1">
                    <Badge bg="secondary" className="px-3 py-2 rounded-3 border border-2 border-dark text-dark">
                        {nombreMascota}
                    </Badge>
                    <Badge bg="secondary" className="px-3 py-2 rounded-3 border border-2 border-dark text-dark">
                        {especieMascota}
